...
class Ui_task_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.accTable.setColumnCount(7)
        ...
        self.accTable.setColumnWidth(1, 85)  # 账号
        self.accTable.setColumnWidth(2, 50)  # 密码
        self.accTable.setColumnWidth(3, 50)  # 邮箱
        self.accTable.setColumnWidth(4, 50)  # 邮箱密码
        self.accTable.setColumnWidth(5, 50)  # 状态
        self.accTable.setColumnWidth(6, 50) # 救援码
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "批量绑定SDA"))
        ...
        item.setText(_translate("MainWindow", "绑定状态"))
        item = self.accTable.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "救援码"))
